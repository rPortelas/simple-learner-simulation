...
if __name__ == "__main__":
    ...
    env = ClassroomToyEnvV2(nb_dims=nb_dims, nb_cubes=nb_cubes, idx_first_cube=12)
    start_time = time.time()
    #test_random(env, nb_episodes, nb_dims=nb_dims, verbose=True, gif=True)
    test_alpgmm(env, nb_episodes, nb_dims=nb_dims, verbose=True, gif=True)
    end_time = time.time()
